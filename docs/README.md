...
- [Connecting Copilot Studio (and the optional SharePoint sync)](copilot_studio_integration.md)
- Deploying:
  ...
  - [Enabling optional features](deploy_features.md)
    - [All features](deploy_features.md)
    - [Document-level access control](login_and_acl.md)
...
- [Customizing the ingestion pipeline](customization.md)
- [App architecture](architecture.md)
- [Data ingestion](data_ingestion.md)
- [Text splitting algorithm](textsplitter.md)
