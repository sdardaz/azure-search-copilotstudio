...
class MockAsyncSearchResultsIterator:
    def __init__(self, search_text, vector_queries: Optional[list[VectorQuery]]):
        if search_text == "greenleaf nursery logo" and (
            vector_queries and any([vector.fields == "images/embedding" for vector in vector_queries])
        ):
            self.data = [
                [
                    {
                        "id": "file-greenleaf_jun28_pdf-73616D706C655F72656365697074237B276F696473273A205B2761303030303030302D303030302D303030302D303030302D303030303030303030303030275D7D-page-0",
                        "content": '<figure><figcaption>1.1 <br>The image displays a generic email-service logo. It consists of a stylized letter "M" with four colors: red, blue, green, and yellow. To the right of the "M" is the word "Mail" written in gray text. The design is modern and clean.</figcaption></figure>\n\n\nJordan Rivera <jordan.rivera@example.com>\n\nReceipt / Tax invoice (#2-108442)\n\nGreen Leaf Nursery <no-reply@example.com>\nReply-To: sam@example.com\nTo: jordan.rivera@example.com\n\nSat, Jun 28, 2025 at 1:21 PM\n\n\n<figure><figcaption>1.2 <br>The image shows the logo of Green Leaf Nursery. The logo features three daffodil flowers on the left side. The text "Green Leaf" is positioned to the right of the flowers. Below "Green Leaf" is the word "Nursery." The design is simple and rendered in black and white.</figcaption></figure>\n\n\nAn Employee-Owned Co-op\n123 Garden Ave, Springfield, ST 00000\n555-0100\n\nMain Outlet\n\nReceipt / Tax Invoice #2-108442 28 Jun 2025 1:21pm\n\n\n<figure><table><tr><td>1 Gopher Baskets</td><td>@ $7.',
                        "category": None,
                        "sourcepage": "sample_receipt.pdf#page=1",
                        "sourcefile": "sample_receipt.pdf",
                        "oids": ["OID_X"],
                        "groups": [],
                        "captions": [],
                        ...
                        "images": [
                            {
                                "url": "https://userst5gj4l5eootrlo.dfs.core.windows.net/user-content/OID_X/images/sample_receipt.pdf/page_0/figure1_1.png",
                                "description": '<figure><figcaption>1.1 <br>The image displays a generic email-service logo. It consists of a stylized letter "M" with four colors: red, blue, green, and yellow. To the right of the "M" is the word "Mail" written in gray text. The design is modern and clean.</figcaption></figure>',
                                "boundingbox": [32.99, 43.65, 126.14, 67.72],
                            },
                            {
                                "url": "https://userst5gj4l5eootrlo.dfs.core.windows.net/user-content/OID_X/images/sample_receipt.pdf/page_0/figure1_2.png",
                                "description": '<figure><figcaption>1.2 <br>The image shows the logo of Green Leaf Nursery. The logo features three daffodil flowers on the left side. The text "Green Leaf" is positioned to the right of the flowers. Below "Green Leaf" is the word "Nursery." The design is simple and rendered in black and white.</figcaption></figure>',
                                "boundingbox": [40.76, 163.42, 347.1, 354.15],
                            },
                        ],
                    },
                    {
                        "id": "file-greenleaf_jun28_pdf-73616D706C655F72656365697074237B276F696473273A205B2761303030303030302D303030302D303030302D303030302D303030303030303030303030275D7D-page-1",
                    ...
                    {
                        "id": "file-greenleaf_jun28_pdf-73616D706C655F72656365697074237B276F696473273A205B2761303030303030302D303030302D303030302D303030302D303030303030303030303030275D7D-page-4",
                        "content": "\n\nIf you have any questions about how to take care of the plants you purchase\nor if they start to show symptoms of ill health, please, give us a call (555-\n0100)\n\nreceipt.pdf\n50K",
                        "category": None,
                        "sourcepage": "sample_receipt.pdf#page=2",
                        "sourcefile": "sample_receipt.pdf",
                        "oids": ["OID_X"],
                        "groups": [],
                        "captions": [],
